...
const Footer = () => {
  return (
    <footer className="bg-gray-50 p-10 border-t border-gray-200 text-gray-700 text-sm">
      {/*
        TODO: Implement the actual design and content based on the '푸터.png' image
        located in the 'public' folder. This includes layout, text, and any specific
        icons or branding elements shown in the image.
      */}
      <div className="max-w-6xl mx-auto flex flex-wrap justify-around gap-5 text-left">
        <div className="flex-1 min-w-[200px]">
          <h3 className="text-gray-800 text-lg font-semibold mb-3">위니브</h3>
          <p className="mb-2 leading-relaxed">스터디를 위한 최고의 플랫폼</p>
          <p className="mb-2 leading-relaxed">
            &copy; 2023 StudyIn. All rights reserved.
          </p>
        </div>
