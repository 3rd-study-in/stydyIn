...
const Button = ({
  ...
  // 기본 공통 스타일
  const baseStyles =
    'inline-flex items-center justify-center font-semibold transition-all duration-200 rounded-[8px] focus:outline-none disabled:cursor-not-allowed';
  ...
  const variantStyles = {
    ...
    kakao:
      'bg-[#FFFFFF] text-[#191919] w-[322px] h-[54px] rounded-[8px] border border-[#FEE500] font-bold hover:bg-[#FADA0A]',
  };
