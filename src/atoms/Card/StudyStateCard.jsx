...
function StudyStateCard({
  ...
  return (
    <div className={`w-[290px] font-sans ${className}`}>
      ...
      {/* 바디 */}
      <div className="bg-white border border-border rounded-lg pt-[36px] pb-5 px-5 flex flex-col gap-xl z-30 relative drop-shadow-lg">
        {/* 제목 */}
        ...
        <div className="flex items-center justify-between w-full">
          {DAYS.map((day) => {
            ...
            return (
              <div
                key={day}
                className={`w-[30px] h-[30px] rounded-full flex items-center justify-center text-sm font-medium ${
                  isSelected
        ...
        <div className="border-t border-border pt-4 flex items-start justify-between">
          <span className="text-sm font-bold text-text shrink-0">시간</span>
        ...
        {/* 모집 인원 */}
        <div className="border-t border-border pt-4 flex items-center justify-between">
          <span className="text-sm font-bold text-text">모집 인원</span>
        ...
        <div className="flex flex-col gap-sm">
          ...
          <div className="flex w-full gap-2">
            ...
            <FlexibleButton
              ...
              className="flex items-center justify-center border-secondary-light cursor-pointer transition-transform"
            >
              {isLiked ? (
